        ...
        <Card className="backdrop-blur-sm bg-white/80 dark:bg-gray-900/80 border-white/20 shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-gray-600 dark:text-gray-400">
              Access your booking dashboard and history
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 text-sm">
              ...
              <div className="space-y-1 text-green-700 dark:text-green-300">
                <div>Email: <code className="font-mono bg-green-100 dark:bg-green-800 px-1 rounded">customer@qayamgah.com</code></div>
                <div>Password: <code className="font-mono bg-green-100 dark:bg-green-800 px-1 rounded">customer123</code></div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" data-testid="customer-login-form">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="customer@qayamgah.com"
                  value={email}
            ...
            <div className="text-center text-sm text-gray-600 dark:text-gray-400">
              <div className="space-y-2">
                <div>
                  Property owner? <Link href="/property-owner/login" className="text-blue-600 dark:text-blue-400 hover:underline" data-testid="link-property-owner-login">Property Owner Login</Link>
                </div>
                <div>
